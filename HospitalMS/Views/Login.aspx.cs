        ...
        protected void Login_Click(object sender, EventArgs e)
        {
            ...
            else if (RoleCb.SelectedIndex == 2)
            {
                ...
                else
                {
                    ...
                    Session["role"] = role;
                    Session.Timeout = 10;
                    string r_url = "../Views/{0}/Prescriptions.aspx";
                    r_url = string.Format(r_url, role);
            ...
            else if (RoleCb.SelectedIndex == 3)
            {
                ...
                else
                {
                    ...
                    Session["role"] = role;
                    Session.Timeout = 10;
                    string r_url = "../Views/{0}/Patients.aspx";
                    r_url = string.Format(r_url, role);
            ...
            else if (RoleCb.SelectedIndex == 4)
            {
                ...
                string Query = "select * from LaboratorianTbl where LabEmail = '{0}' and LapPass = '{1}' ";
                Query = string.Format(Query, EmailTb.Value, PasswordTb.Value);
                DataTable dt = Con.GetDatas(Query);
                ...
                else
                {
                    ...
                    Session["role"] = role;
                    Session.Timeout = 10;
                    string r_url = "../Views/{0}/LabTest.aspx";
                    r_url = string.Format(r_url, role);
